				...
				<section className={'mt-12 rounded-lg border border-neutral-300 bg-white p-6 shadow-sm'}>
					<div className={'space-y-6 text-neutral-700 text-base sm:text-lg'}>
						<div>
							...
							<p>
								{'If you want to enable users to deposit into Yearn vaults from your dApp, you can partner with Yearn and earn a 50% split of both the management and performance fees generated by the TVL you direct to Yearn vaults. Dashboard fee figures are estimates: management-fee accrual uses each chain’s average block time, while performance fees use observed vault performance. This applies only to Yearn v3 vaults and active yLockers, as we do not currently wish to incentivize building on older Yearn projects.'}
							</p>
						</div>
						<div>
							...
							<p>
								...
								{'. You will start earning fees as soon as users start depositing through the referral contract using your referral code! Lastly, we need to flip the switch by making the login page work for you so you can track your progress.'}
							</p>
						</div>
						<div>
						...
						<div>
							<p className={'text-lg font-semibold text-neutral-900 sm:text-xl'}>{'How do referrals work for yBOLD and ysyBOLD?'}</p>
							<p>
								{'yBOLD is unique in that it has a 2-step process to receive the yield of ysyBOLD. Because of this, getting referrals for ysyBOLD deposits does not go through the standard wrapper contract. Instead, you must deposit through the dedicated zap contract at '}
								<a
									className={'text-primary-600 underline'}
									href={'https://etherscan.io/address/0xaACE12d8e8B8BCD16212CB656C912dBC36EFD782'}
									rel={'noreferrer'}
									target={'_blank'}>
									{'0xaACE12d8e8B8BCD16212CB656C912dBC36EFD782'}
								</a>
								{'.'}
							</p>
						</div>
